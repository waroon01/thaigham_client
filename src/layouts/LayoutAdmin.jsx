  ...
  return (
    <div>
      <div className="flex h-screen overflow-hidden">
        ...
        <div
          id="sidebar"
          className="sidebar bg-purple-900 text-white w-64 flex flex-col"
        >
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <NavLink
              to="/admin"
              className="menu-item flex items-center px-4 py-3 text-white rounded-lg hover:bg-purple-800 mb-1"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
