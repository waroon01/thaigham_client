...
const LayoutAdmin = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden relative">
      {/* Sidebar */}
      <div
        className={`bg-purple-900 text-white w-64 flex flex-col fixed md:static z-20 transition-transform duration-300 transform ${
      ...
      >
        ...
        <nav className="mt-5 px-2 flex-1 overflow-y-auto">
          ...
          <a
            href="#reports"
            className="flex items-center px-4 py-3 rounded-lg hover:bg-purple-800 mb-1"
          >
            <svg className="h-6 w-6 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path
                strokeLinecap="round"
